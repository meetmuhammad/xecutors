    ...
    >
      ...
      <div className="max-w-[1320px] w-full px-[12px] mx-auto">
        <div className="flex items-center">
          <div
            className="w-full  wow tpfadeRight"
          ...
          >
            <div className="tp-fea-right-side">
              <div className="tp-fea-section-box">
                ...
                <h2 className="max-w-title tp-title-sm pb-65 text-center text-[50px] text-[#222831]">
                  {title}
                  ...
                  return (
                    <div key={id} className="tp-feature-list d-flex">
                      ...
                      <div className="tp-feature-list__content">
                        <h4 className="text-[#222831] text-[22px]">{title}</h4>
                        <p className="text-[14px] leading-[20px] mb-0">{subtitle}</p>
